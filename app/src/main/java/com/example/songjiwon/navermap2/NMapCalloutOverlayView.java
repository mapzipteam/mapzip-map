...
public abstract class NMapCalloutOverlayView extends FrameLayout implements NMapOverlayManager.CalloutOverlayViewInterface {
    ...
    public NMapCalloutOverlayView(Context context, NMapOverlay itemOverlay, NMapOverlayItem item, Rect itemBounds) {
        ...
        NMapView.LayoutParams lp = new NMapView.LayoutParams(NMapView.LayoutParams.WRAP_CONTENT, NMapView.LayoutParams.WRAP_CONTENT, mOverlayItem.getPoint(), px, -py, NMapView.LayoutParams.BOTTOM_CENTER);
    ...
    private void animateCallout() {
        ScaleAnimation animation = new ScaleAnimation(0.5f, 1.0f, 0.5f, 1.0f, ScaleAnimation.RELATIVE_TO_SELF, 0.5f, ScaleAnimation.RELATIVE_TO_SELF, 1.0f);
