...
/**
 * Created by Song  Ji won on 2015-07-28.
 */
public class Location {
    ...
    ///서울 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///1.강남구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///2.강동구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///3.강북구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///4.강서구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///5.관악구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///6.광진구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///7.구로구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///8.금천구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///9.노원구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///10.도봉구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///11.동대문구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///12.동작구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///13.마포구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///14.서대문구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///15.서초구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///16.성동구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///17.성북구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///18.송파구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///19.양천구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///20.영등포구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///21.용산구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///22.은평구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///23.종로구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///24.중구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    ///25.중랑구 중심좌표 경도(LNG), 위도(LAT), NGeoPoint 좌표
    ...
    public static Location getInstance()
    {
        if(ourInstance == null)
        {
            ourInstance = new Location();
        }
        return ourInstance;
    }

    public static NGeoPoint setLocation(int btn_num)
    {
        NGeoPoint curr_location = SEOUL;

        if(btn_num==1)
        {
            curr_location = GANGNAMGU;
        }
